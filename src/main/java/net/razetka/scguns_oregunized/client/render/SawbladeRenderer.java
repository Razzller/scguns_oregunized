package net.razetka.scguns_oregunized.client.render;
...
public class SawbladeRenderer extends EntityRenderer<ProjectileEntity> {
    protected SawbladeRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
    ...
    public void render(ProjectileEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light)
    {
        ...
        float spin = (entity.tickCount + partialTicks) * 32.0F;
