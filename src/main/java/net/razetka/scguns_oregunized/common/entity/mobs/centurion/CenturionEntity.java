...
public class CenturionEntity extends Monster {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(CenturionEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ATTACK_TIMEOUT =
            SynchedEntityData.defineId(CenturionEntity.class, EntityDataSerializers.INT);

    public CenturionEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        if (hasGun) {
            this.goalSelector.addGoal(2, new GunAttackGoal<>(this, this.getMainHandItem(), 1.0F, AIType.TACTICAL, 4));
        }
        else {
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData spawnData, @Nullable CompoundTag dataTag) {
        EntityEquipmentConfig.equipEntity(this, "scguns_oregunized:centurion");
    ...
    public void setTarget(@Nullable LivingEntity target) {
        if (target != null && target.getType().is(ModTags.Entities.WHITE_WOLF_MOBS)) {
            return;
        }
