package net.razetka.scguns_oregunized.common.entity.mobs.tirone;// Made with Blockbench 5.1.3
...
public class TironeModel<T extends TironeEntity> extends HierarchicalModel<T> implements ArmedModel {
	...
	public TironeModel(ModelPart root) {
		this.root = root;
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(0, 0).addBox(-5.0F, -6.0F, -5.0F, 10.0F, 1.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition head_r1 = head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(32, 18).addBox(-1.5F, -3.0F, 0.0F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.7071F, -2.0F, -4.5F, 0.0F, -0.7854F, 0.0F));

		PartDefinition head_r2 = head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(32, 11).addBox(-1.0F, -0.5F, 0.375F, 3.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -4.5F, -4.5F, 0.0F, 0.7854F, 0.0F));

		PartDefinition head_r3 = head.addOrReplaceChild("head_r3", CubeListBuilder.create().texOffs(16, 55).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition head_r4 = head.addOrReplaceChild("head_r4", CubeListBuilder.create().texOffs(40, 46).addBox(-5.0F, -3.0F, 0.5F, 9.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.5F, 2.5F, 1.1781F, 0.0F, 0.0F));
