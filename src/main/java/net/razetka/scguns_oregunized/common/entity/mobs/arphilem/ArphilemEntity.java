...
public class ArphilemEntity extends Monster {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(ArphilemEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> ATTACK_TIMEOUT =
            SynchedEntityData.defineId(ArphilemEntity.class, EntityDataSerializers.INT);

    public ArphilemEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
        ...
        this.targetSelector.addGoal(1, new HurtByTargetGoal(this) {
            ...
            public boolean canUse() {
                if (this.mob.getLastHurtByMob() != null &&
                        this.mob.getLastHurtByMob() instanceof ArphilemEntity) {
                    return false;
                }
                return super.canUse();
            }
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType reason, @org.jetbrains.annotations.Nullable SpawnGroupData spawnData, @org.jetbrains.annotations.Nullable CompoundTag dataTag) {
        EntityEquipmentConfig.equipEntity(this, "scguns_oregunized:arphilem");
