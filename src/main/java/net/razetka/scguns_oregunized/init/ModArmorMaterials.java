...
public enum ModArmorMaterials implements ArmorMaterial {
    MAUVITE("potin", 26, new int[]{2, 7, 6, 2}, 5,
            SoundEvents.ARMOR_EQUIP_IRON, 0f, 0.1f, () -> Ingredient.of(ModItems.MAUVITE_INGOT.get()));
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound,
        ...
        this.protectionAmount = protectionAmounts;
        this.enchantmentValue = enchantmentValue;
        this.equipSound = equipSound;
        this.toughness = toughness;
        this.knockbackResistance = knockbackResistance;
        this.repairIngridient = repairIngredient;
    }
    ...
    public String getName() {
        return ScGunsOregunized.MOD_ID + ":" + this.name;
    }
